 ...
 *
 * $Id: dhd_linux.c 442539 2013-12-11 23:02:52Z $
 */
...
#if defined(GAN_LITE_NAT_KEEPALIVE_FILTER)
...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
...
#else
	/* Setup accept definitions for pktfilter , enable in suspend */
	...
	dhd->pktfilter[DHD_MULTICAST4_FILTER_NUM] = NULL;
	/* Allow all IPv6 multicast packets */
	dhd->pktfilter[DHD_MULTICAST6_FILTER_NUM] = "103 0 0 0 0xFFFF 0x3333";
	/* discard mdns */
	dhd->pktfilter[DHD_MDNS_FILTER_NUM] = NULL;
	/* Allow ARP (only with IBSS and P2P, otherwise offloaded to wifi chip */
	dhd->pktfilter[DHD_ARP_FILTER_NUM] = "105 0 0 12 0xFFFF 0x0806";
	/* discard IPv4 broadcast address XXX.XXX.XXX.255 */
	dhd->pktfilter[DHD_IPV4_BC_255_FILTER_NUM] = NULL;
	/* discard IPv4 multicast address 224.0.0.0/4 */
	dhd->pktfilter[DHD_IPV4_MC_224_FILTER_NUM] = NULL;
	/* discard IPv6 multicast address FF00::/8 */
	dhd->pktfilter[DHD_IPV6_MC_FF00_FILTER_NUM] = NULL;
	/* Allow (DHCPv4) multicast (255.255.255.255 with source port of 67 and destionation 68) */
	dhd->pktfilter[DHD_DHCPV4_FILTER_NUM] = "109 0 0 12 0xFFFF00000000000000000000000000000000FFFFFFFFFFFFFFFF 0x080000000000000000000000000000000000FFFFFFFF4344";
#endif /* !BOARD_INTEL */
